...
export async function getDashboardMetrics(user: AppSessionUser): Promise<DashboardMetrics> {
  const [row] = await prisma.$queryRaw<DashboardMetricsRow[]>(Prisma.sql`
    ...
    SELECT
      ...
      (COUNT(*) FILTER (WHERE job_state_number IN (2, 3, 4, 5, 6, 7)))::int AS "mainJobs",
      (COUNT(*) FILTER (WHERE department_code = 'VAT' AND job_state_number IN (3, 4, 5, 6, 7) AND xpm_state NOT LIKE '%3.1%' AND xpm_state NOT LIKE '%3.2%'))::int AS "vatJobs",
      (COUNT(*) FILTER (WHERE department_code = 'SOFTWARE_BK' AND job_state_number IN (3, 4, 5, 6, 7) AND xpm_state NOT LIKE '%3.1%' AND xpm_state NOT LIKE '%3.2%'))::int AS "softwareBkJobs",
      (COUNT(*) FILTER (WHERE department_code = 'BK' AND job_state_number IN (3, 4, 5, 6, 7) AND xpm_state NOT LIKE '%3.1%' AND xpm_state NOT LIKE '%3.2%'))::int AS "bkJobs",
      (COUNT(*) FILTER (WHERE department_code = 'AFS' AND job_state_number IN (3, 4, 5, 6, 7) AND xpm_state NOT LIKE '%3.1%' AND xpm_state NOT LIKE '%3.2%'))::int AS "afsJobs",
      (COUNT(*) FILTER (WHERE department_code = 'UNCLASSIFIED' AND job_state_number IN (3, 4, 5, 6, 7) AND xpm_state NOT LIKE '%3.1%' AND xpm_state NOT LIKE '%3.2%'))::int AS "unclassifiedJobs",
      (COUNT(*) FILTER (
        WHERE NOT EXISTS (
          SELECT 1
  ...
  const rows = await prisma.$queryRaw<ClientSummaryRow[]>(Prisma.sql`
    ...
    client_summaries AS (
      SELECT
        ...
        (COUNT(*) FILTER (WHERE department_code = 'BK' AND job_state_number IN (3, 4, 5, 6, 7) AND xpm_state NOT LIKE '%3.1%' AND xpm_state NOT LIKE '%3.2%'))::int AS "bkJobs",
        (COUNT(*) FILTER (WHERE department_code = 'AFS' AND job_state_number IN (3, 4, 5, 6, 7) AND xpm_state NOT LIKE '%3.1%' AND xpm_state NOT LIKE '%3.2%'))::int AS "afsJobs",
        (COUNT(*) FILTER (WHERE department_code = 'QC' AND job_state_number IN (3, 4, 5, 6, 7) AND xpm_state NOT LIKE '%3.1%' AND xpm_state NOT LIKE '%3.2%'))::int AS "qcJobs",
        (COUNT(*) FILTER (WHERE department_code = 'UNCLASSIFIED' AND job_state_number IN (3, 4, 5, 6, 7) AND xpm_state NOT LIKE '%3.1%' AND xpm_state NOT LIKE '%3.2%'))::int AS "unclassifiedJobs"
